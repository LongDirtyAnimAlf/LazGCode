...
type
  ...
  protected
    ...
    FCurrentSegmentColor: TBGRAPixel;
  ...
  public
    ...
    property CurrentSegmentColor: TBGRAPixel read FCurrentSegmentColor;
  ...
  public
    ...
    procedure addColor(const AColor: TBGRAPixel);
...
const
  ...
  (0, Sizeof(TMoveToElement), Sizeof(TClosePathElement), sizeof(TPointF),
   ...
   sizeof(TSplineElement)+sizeof(integer),Sizeof(TColorElement));
...
begin
  case FCurrentElementType of
    ...
    peColor,peMoveTo,peLineTo,peCloseSubPath:
...
begin
  ...
  FCurrentSegmentColor := BGRABlack;
  PrepareCurrentElement;
...
procedure TBGRAPath.addColor(const AColor: TBGRAPixel);
begin
  if FLastSubPathElementType <> peColor then
  begin
    with PColorElement(AllocateElement(peColor))^ do
    begin
      Color:=LongWord(BGRA(AColor.red, AColor.green, AColor.blue, AColor.alpha));
    end
  end else
    PColorElement(FData+(FDataPos-Sizeof(TColorElement)))^.Color := LongWord(BGRA(AColor.red, AColor.green, AColor.blue, AColor.alpha));
