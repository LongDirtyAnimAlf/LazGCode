...
begin
  ...
  begin
    ...
    with ACursor.CurrentTangent do textAngle := arctan2(y,x);
    with ACursor.CurrentCoordinate do
    begin
      if ATexture = nil then
        TextOutAngle(x,y, system.round(-textAngle*1800/Pi), currentGlyphUtf8, AColor, taCenter)
      else
        TextOutAngle(x,y, system.round(-textAngle*1800/Pi), currentGlyphUtf8, ATexture, taCenter);
    end;
